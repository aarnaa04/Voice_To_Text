...
public class VoiceRecognitionActivity extends Activity implements
    ...
    public void onPartialResults(Bundle bundle) {
        ...
        Log.i(LOG_TAG, "onPartialResults:" + sTextFromSpeech);
    ...
    public void onResults(Bundle results) {
        ...
        for (String result : matches) {
            if (matches.contains(1)) //check if the list contains the element
            {
                text = matches.get(matches.indexOf(1));//get the element by passing the index of the element
            }
            text += result + "\n";
